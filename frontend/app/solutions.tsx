...
import { Button, Card, CardBody, CardHeader, Spinner, Progress } from "@nextui-org/react";
...
export default function SolutionsPage() {
    ...
    const [expandedSolution, setExpandedSolution] = useState<{cause: number, solution: number} | null>(null);
